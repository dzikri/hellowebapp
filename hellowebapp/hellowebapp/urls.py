...
#     # Create Quote after Registration
#     url(r'^accounts/register/$', MyRegistrationView.as_view(), name='registration_register'),
#     url(r'^accounts/create-quote/$', views.create_quote, name='registration_create_quote'),
#
...
urlpatterns = [
    ...
    url(r'^s/$', RedirectView.as_view(pattern_name='browse')),
    url(r'^quotes/(?P<slug>[-\w]+)/$',
        views.quote_detail, name='quote_detail'),
    ...
    url(r'^accounts/create_quote/$',
        views.create_quote, name='registration_create_quote'),
